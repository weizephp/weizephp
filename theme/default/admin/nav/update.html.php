...
<html>
    <head>
        <?php include $wconfig['theme_path'] . '/admin/head.inc.php';echo admin_head('导航更新');?>
    ...
    <body>
        <?php include $wconfig['theme_path'] . '/admin/header.html.php';?>
            ...
            <form class="form-horizontal w-form" autocomplete="off">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="pid" name="pid">
                            ...
                            foreach($nav_list as $val) {
                                if( $val['nid'] == $nav['pid'] ) {
                                    echo '<option value="'. $val['nid'] .'" selected="selected">'. $val['name'] .'</option>';
                                } else {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($nav['name']);?>" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="status" name="status">
                            <?php
                            if( $nav['status'] == 1 ) {
                                echo '<option value="1" selected="selected">是</option><option value="0">否</option>';
                            } else {
                                echo '<option value="1">是</option><option value="0" selected="selected">否</option>';
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="listorder" name="listorder" value="<?php echo $nav['listorder'];?>" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="url" name="url" value="<?php echo $nav['url'];?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($nav['description']);?>" />
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <input type="hidden" name="nid" value="<?php echo $nav['nid'];?>" />
                        <input type="hidden" name="pic_delete" value="no" id="pic_delete" />
                        <button type="submit" class="btn btn-default">提 交</button>
                        - <a class="btn btn-info w-a-btn" href="?m=nav&a=list">返回上一页</a>
                    </div>
                </div>
            </form>
        ...
        $(document).ready(function() {
            ...
            $('.w-form').submit(function() {
                $.post("?m=nav&a=update", $(this).serialize(), function(result) {
                    if(result.status == 1) {
