            ...
            <div class="table-responsive">
                <table class="table w-table">
                    ...
                    <tbody>
                        <tr>
                            <td>WeizePHP 程序版本</td>
                            <td><?php echo $wconfig['version'];?> <a class="w-red" target="_blank" href="http://weizephp.75hh.com/">查看最新版本</a></td>
                        </tr>
                        <tr>
                            <td>服务器系统及 PHP</td>
                    ...
                    <tbody>
                        <tr>
                            <td>版权问题</td>
                            <td><a class="w-red" target="_blank" href="http://opensource.org/licenses/MIT">MIT License.</a> (可以自由商业化的哟^_^)</td>
                        </tr>
                        <tr>
                            <td>项目总策划</td>
                            <td>韦泽</td>
